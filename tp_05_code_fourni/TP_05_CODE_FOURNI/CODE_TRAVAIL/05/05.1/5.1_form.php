        ...
        >
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input type="hidden" name="hide" id="id_f_cache" value="test caché" />
                </p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <select name="liste" id="id_f_liste2" size="1" tabindex="180">
                ...
                <p>
                    ...
                    <select name="liste2" id="id_f_liste3" size="3" tabindex="190">
                        <optgroup label="Amérique">
                            <option value="canada"> Canada </option>
                ...
                <p>
                    ...
                    <select name="liste3" id="id_f_liste4" size="5" multiple="multiple"
                            tabindex="200">
