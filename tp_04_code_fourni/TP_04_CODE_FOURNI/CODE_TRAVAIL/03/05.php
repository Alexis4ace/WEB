...
<html lang="fr">
    ...
    <body>
        ...
        <div>
            ...
            <?php
                // TODO : $villes = ...
                $villes = array('Paris', 'Londres', 'Madrid');//todo ligne à supprimer, présente pour la compilation
        ...
        <div>
            ...
            <?php
                ...
                $villes2 = array_values($villes);//todo ligne à supprimer, présente pour la compilation
            ...
            <?php
                ...
                $villes2 = array_keys($villes) ;//todo ligne à supprimer, présente pour la compilation
                afficheTableauTer($villes2);
            ?>
        </div>
