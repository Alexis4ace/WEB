<?php
    ...
    function bd_connexion()
    {
        ...
        try{
            ...
            $bd_obj->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_WARNING);
            $bd_obj->query('PRAGMA foreign_keys = ON;'); 
        }
        catch (Exception $e ){
            exit('errreur connexion bd');
        }
        // TODO 3.2 :
        // - on fait ici le try/catch pour affecter $bd_obj
        // - on paramètre l'attribut PDO::ATTR_ERRMODE avec la valeur PDO::ERRMODE_WARNING
